...
import { StyledHeading, StyledBody, StyledCaption } from '../components/Styles/StyledBodyElements';

import resume from "../img/res.jpg";
...
const Experiences = () => {
    ...
    return(
        <div>
            <StyledHeading> Experiences </StyledHeading>
            <StyledBody
